...
- Navigate the Microsoft Defender portal to investigate incidents using embedded Copilot capabilities.
- Analyze and interpret incident summaries automatically generated by Copilot for Security.
...
- Utilize the Microsoft Copilot for Security Promptbook Library to conduct in-depth incident investigations.
- Create detailed reports summarizing incidents, extracted entities, and findings through Microsoft Copilot for Security.
